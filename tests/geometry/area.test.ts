...
describe('area', () => {
  test('area has expected defaults', () => {
    ...
    expect(channels).toEqual({
      x: { name: 'x', optional: false, scale: undefined },
      y: { name: 'y', optional: false, scale: undefined },
      x1: { name: 'x1', optional: false, scale: undefined },
      y1: { name: 'y1', optional: false, scale: undefined },
      z: { name: 'z', optional: true, scale: undefined },
      fill: { name: 'fill', optional: true, scale: undefined },
      stroke: { name: 'stroke', optional: true, scale: undefined },
    });
  });
