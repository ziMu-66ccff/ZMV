...
describe('axisX', () => {
  const domain: [number | string, number | string] = [0, 10];
  ...
  test('cartesian', () => {
    ...
    firstOf(svg as any, 'tick').toEqual({
      x1: '30',
      x2: '30',
      y1: '370',
      y2: '375',
    ...
    firstOf(svg as any, 'text').toEqual({
      'text-anchor': 'middle',
      x: '30',
      y: '375',
      dy: '1em',
    ...
    firstOf(svg as any, 'label').toEqual({
      textContent: 'val 👉',
      x: '570',
      y: '375',
    });
  ...
  test('polar', () => {
    ...
    firstOf(svg as any, 'label').toBeNull();
  });
